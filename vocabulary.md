...
| :--- | :--- | :--- |
| Example | Ví dụ, mẫu | This is an example word. |
| magnitude | Độ lớn, tầm quan trọng, cường độ | Xem chi tiết bên dưới. |
| intuition | Trực giác | Khả năng hiểu bằng cảm nhận, bản năng. |
| objectives | Mục tiêu, mục đích | Những kết quả cụ thể cần đạt được. |
| span | Không gian sinh, khoảng, quãng | Tập hợp tổ hợp tuyến tính (Toán); Khoảng cách/thời gian. |
...
- **Nghĩa 2: Tầm quan trọng, mức độ nghiêm trọng** (Importance/Severity)
  - *Ví dụ*: "I don't think you realize the magnitude of the problem." (Tôi không nghĩ bạn nhận ra tầm quan trọng của vấn đề.)
- **Nghĩa 3: Cường độ (Địa chất)** (Intensity of earthquake)
  - *Ví dụ*: "The earthquake had a magnitude of 6.5." (Trận động đất có độ lớn 6.5 Richter.)
- **Nghĩa 4: Độ sáng (Thiên văn)** (Brightness of a star)
- **Nghĩa 5: Độ lớn (Toán học & Vật lý)** (Scalar value/Vector length)
...
- **Nghĩa 2: Khách quan** (Adjective - *Objective*)
  - *Lưu ý*: Mặc dù bạn gửi số nhiều (danh từ), nhưng tính từ "objective" rất phổ biến, nghĩa là không bị ảnh hưởng bởi cảm xúc cá nhân.
  - *Ví dụ*: "We need an objective opinion." (Chúng tôi cần một ý kiến khách quan.)
- **Nghĩa 3: Vật kính** (Noun - Optics)
  ...
  - **Nghĩa 1: Không gian sinh / Bao tuyến tính** (Mathematics - Linear Algebra)
    ...
    - *Ví dụ*: "The span of two non-collinear vectors in $\mathbb{R}^3$ is a plane." (Không gian sinh của hai vectơ không cùng phương trong $\mathbb{R}^3$ là một mặt phẳng.)
  - **Nghĩa 2: Khoảng thời gian / Quãng thời gian** (Noun - Time)
    - *Ví dụ*: "Attention span" (Khoảng thời gian tập trung), "Life span" (Tuổi thọ).
  - **Nghĩa 3: Nhịp, sải, khoảng cách** (Noun - Distance)
    - *Ví dụ*: "Wing span" (Sải cánh), "The span of a bridge" (Nhịp cầu).
  - **Nghĩa 4: Bắc qua, kéo dài qua** (Verb)
...
- **Nghĩa 2: Từ con số không / Từ đầu** (Idiom - *From scratch*)
  - *Ngữ cảnh*: Xây dựng hệ thống (Toán học hoặc Lập trình) từ những nguyên lý cơ bản nhất mà không dùng thư viện hay kết quả có sẵn.
  - *Ví dụ*: "We built the algorithm from scratch." (Chúng tôi đã xây dựng thuật toán từ đầu.)
- **Nghĩa 3: Lập trình Scratch** (Computer Science)
  - *Ngữ cảnh*: Ngôn ngữ lập trình trực quan dựa trên khối lệnh của MIT dành cho người mới bắt đầu.
- **Nghĩa 4: Bộ nhớ tạm / Vùng đệm** (CS - *Scratch Space/Disk*)
  - *Ngữ cảnh*: Vùng lưu trữ tạm thời để xử lý dữ liệu trung gian.
- **Nghĩa 5: Vết xước, sự gãi, cào** (Noun/Verb - Common usage)
...
- **Nghĩa 2: Đại lượng vô hướng** (Physics)
  ...
  - *Ví dụ*: "Temperature, mass, and energy are scalar quantities." (Nhiệt độ, khối lượng và năng lượng là các đại lượng vô hướng.)
- **Nghĩa 3: Biến scalar / Kiểu dữ liệu đơn biến** (Computer Science)
  - *Định nghĩa*: Kiểu dữ liệu chỉ chứa một giá trị duy nhất tại một thời điểm (như `int`, `float`, `bool`), phân biệt với các kiểu dữ liệu phức hợp như `array` hay `list`.
...
- **Nghĩa 2: Phản ứng tách** (Chemistry - *Elimination Reaction*)
  - *Định nghĩa*: Phản ứng trong đó hai nhóm thế bị loại bỏ khỏi một phân tử, thường tạo ra liên kết đôi hoặc liên kết ba (ví dụ: tách nước từ rượu).
- **Nghĩa 3: Sự bài tiết / Đào thải** (Biology/Medicine)
